...
# 1 "userLibs/74hc4094.h" 1
# 34 "userLibs/74hc4094.h"
...
void write74hc4094(uint16_t* _dataOut) {
    ...
    for (j = 0; j < 8 ; j++) {
        ...
        LATA = (((uint16_t)*_dataOut >> j) & 0b1) ? (LATA |= (1 << (0x4))) : (LATA &= ~(1 << (0x4)));
