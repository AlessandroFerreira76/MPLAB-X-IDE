# 1 "mcp2515_driver/mcp2515_driver_pal.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "mcp2515_driver/mcp2515_driver_pal.c" 2
...
# 8 "mcp2515_driver/mcp2515_driver_pal.c" 2
# 20 "mcp2515_driver/mcp2515_driver_pal.c"
void pal_spi_init(void* data, uint8_t data_direction, uint8_t idle_level, uint8_t shift_edge)
{

}
# 33 "mcp2515_driver/mcp2515_driver_pal.c"
...
# 49 "mcp2515_driver/mcp2515_driver_pal.c"
void pal_deselect_slave(void)
{

    LATC |= (1 << (0x2));
}
# 64 "mcp2515_driver/mcp2515_driver_pal.c"
void pal_spi_send(uint8_t byt)
{
...
# 85 "mcp2515_driver/mcp2515_driver_pal.c"
uint8_t pal_spi_read(void)
{
    uint8_t ret;
